...
void Player::Update(const Stage& stage)
{
	...
	if (hoge)
	{
		...
		if (verticalRotation > MathF::PIf / 2 - MathF::AngleConvRad(1.0f)) verticalRotation = MathF::PIf / 2 - MathF::AngleConvRad(1.0f);
		if (verticalRotation < -MathF::PIf / 2 + MathF::AngleConvRad(1.0f)) verticalRotation = -MathF::PIf / 2 + MathF::AngleConvRad(1.0f);
	...
	else
	{
		...
		if (rotation.x > MathF::PIf / 2 - MathF::AngleConvRad(1.0f)) rotation.x = MathF::PIf / 2 - MathF::AngleConvRad(1.0f);
		if (rotation.x < -MathF::PIf / 2 + MathF::AngleConvRad(1.0f)) rotation.x = -MathF::PIf / 2 + MathF::AngleConvRad(1.0f);
	}
