...
void PipelineManager::Initialize()
{
	...
	DitherOutLinePipeLine();

	CharactorDitherPipeLine();
...
void PipelineManager::DitherOutLinePipeLine()
{
	PipelineSet pSet;

	//シェーダー設定
	pSet.vs.shaderName = "Resources\\Shader\\DitherOutlineVS.hlsl";
	pSet.ps.shaderName = "Resources\\Shader\\DitherOutlinePS.hlsl";
	...
	std::string pipeLineName = "DitherOutline";
	sPipelines[pipeLineName] = pSet;
}

void PipelineManager::CharactorDitherPipeLine()
{
	PipelineSet pSet;

	pSet.vs.shaderName = "Resources\\Shader\\CharactorDTVS.hlsl";
	pSet.ps.shaderName = "Resources\\Shader\\CharactorDTPS.hlsl";
	...
	std::string pipeLineName = "CharactorDither";
	sPipelines[pipeLineName] = pSet;
}

void PipelineManager::BillboardPipeLine()
{
	PipelineSet pSet;

	pSet.vs.shaderName = "Resources\\Shader\\BillboardVS.hlsl";
	pSet.ps.shaderName = "Resources\\Shader\\BillboardPS.hlsl";
	...
	std::string pipeLineName = "Billboard";
	sPipelines[pipeLineName] = pSet;
}

void PipelineManager::BackGroundPipeLine()
{
	PipelineSet pSet;

	pSet.vs.shaderName = "Resources\\Shader\\BackGroundVS.hlsl";
	pSet.ps.shaderName = "Resources\\Shader\\BackGroundPS.hlsl";
	...
	std::string pipeLineName = "BackGround";
	sPipelines[pipeLineName] = pSet;
}
